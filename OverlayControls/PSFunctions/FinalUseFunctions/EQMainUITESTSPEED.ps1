...
(get-module -name CursorPosition).ExportedCommands
(Get-Cursor).x
...
$form.Text = 'Set Focus'
$form.Size = New-Object System.Drawing.Size(($ButtonLength*6+50),(($ButtonHight*2+6)*2))
$Form.maximumsize = New-Object System.Drawing.Size(($ButtonLength*6+50),(($ButtonHight*2+5)*2))
